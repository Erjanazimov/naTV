        ...
        <div className="wrapper">
            <div className="container-natv content-natv">
                <nav className="topMenu d-flex justify-content-around">
                    ...
                    <a href="#" className="active">Размещение баннерной рекламы </a>
                </nav>
                ...
                <form className="form">
                    <div className="pd-40 mn">
                        <div className="@media textarea-fons">
                            ...
                            <button className="btn mx-2 img-btn" >Загрузить</button> </p>
                        ...
                        <div className="@media cont">
                            ...
                            <p>
                                <a href="#">
                                    ...
                                    <img src="https://natv.kg/files/%D0%BA%D0%B0%D1%81%D1%81%D0%B0-24.jpg?1512388648609" />
                            ...
                            <div className="content-news">
                                <div>
                                    <div className="d-flex justify-content-between mt-3 flex-wrap">
                                        <div className="d-flex align-items-center news">
                                            <div className="img">
                                                <img src="https://natv.kg/cache/files/1285.jpg_w130_h65_resize.jpg" />
                                            </div>
                                ...
                                <div>
                                    <div className="d-flex justify-content-between mt-3 flex-wrap">
                                        <div className="d-flex align-items-center news">
                                            <div className="img">
                                                <img src="https://natv.kg/cache/files/1305.jpg_w130_h65_resize.jpg" />
                                            </div>
                                ...
                                <div>
                                    <div className="d-flex justify-content-between mt-3 flex-wrap">
                                        <div className="d-flex align-items-center news">
                                            <div className="img">
                                                <img src="https://natv.kg/cache/files/1289.jpg_w130_h65_resize.jpg" />
                                            </div>
                                ...
                                <div>
                                    <div className="d-flex justify-content-between mt-3 flex-wrap">
                                        <div className="d-flex align-items-center news">
                                            <div className="img">
                                                <img src="https://natv.kg/cache/files/2150.jpg_w130_h65_resize.jpg" />
                                            </div>
                                ...
                                <div>
                                    <div className="d-flex justify-content-between mt-3 flex-wrap">
                                        <div className="d-flex align-items-center news">
                                            <div className="img">
                                                <img src="https://natv.kg/cache/files/1363.gif_w130_h65_resize.gif" />
                                            </div>
                                ...
                                <div>
                                    <div className="d-flex justify-content-between mt-3 flex-wrap">
                                        <div className="d-flex align-items-center news">
                                            <div className="img">
                                                <img src="https://natv.kg/cache/files/1356.gif_w130_h65_resize.gif" />
                                            </div>
                                ...
                                <div>
                                    <div className="d-flex justify-content-between mt-3 flex-wrap">
                                        <div className="d-flex align-items-center news">
                                            <div className="img">
                                                <img src="https://natv.kg/cache/files/2662.png_w130_h65_resize.png" />
                                            </div>
                                ...
                                <div>
                                    <div className="d-flex justify-content-between mt-3 flex-wrap">
                                        <div className="d-flex align-items-center news">
                                            <div className="img">
                                                <img src="https://natv.kg/cache/files/1979.jpg_w130_h65_resize.jpg" />
                                            </div>
                                ...
                                <div>
                                    <div className="d-flex justify-content-between mt-3 flex-wrap">
                                        <div className="d-flex align-items-center news">
                                            <div className="img">
                                                <img src="https://natv.kg/cache/files/1831.jpg_w130_h65_resize.jpg" />
                                            </div>
